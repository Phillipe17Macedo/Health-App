...
interface ConfirmacaoGuiaExameProps {
  visivel: boolean;
  onClose: () => void;
...
export default function ConfirmacaoGuiaExame({ visivel, onClose, onConfirm, consulta }: ConfirmacaoGuiaExameProps) {
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <Text style={[styles.modalTitle, {fontFamily: 'MPlusRounded1c-ExtraBold'}]}>Confirmação da Guia de Exame</Text>
